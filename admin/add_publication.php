...
function tp_add_publication_page() {
    ...
    echo '<input type="text" name="post_title" size="30" title="' . __('Title','teachpress') . '" tabindex="1" placeholder="' . __('Title','teachpress') . '" value="' . stripslashes($pub_data["title"]) . '" id="title" autocomplete="off" />';
    echo '</div>';
    echo '</div>';
...
class tp_publication_page {
    ...
    public static function get_comments_box ($pub_data) {
        echo '<div class="postbox">';
        echo '<h3 class="tp_postbox"><span>' . __('MLS Authors Listing','teachpress') . '</span></h3>';
        echo '<div class="inside">';
        // note
        echo tp_admin::get_form_field('note', __('MLS listing of publication authors','teachpress'),__('Publication Authors','teachpress'),'textarea', '', $pub_data["note"], array(''), 32, 'width:95%; height: 75px;');
        echo '</div>';
        echo '</div>';
        echo '<div class="postbox">';
        echo '<h3 class="tp_postbox"><span>Comments</span></h3>';
        echo '<div class="inside">';
        // comment
        echo tp_admin::get_form_field('comment', __('A not visible private comment','teachpress'),__('private comment','teachpress'),'textarea', '', $pub_data["comment"], array(''), 31, 'width:95%; height: 75px;');
        echo '</div>';
        echo '</div>';
    }
